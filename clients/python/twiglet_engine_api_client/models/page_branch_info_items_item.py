...
T = TypeVar("T", bound="PageBranchInfoItemsItem")


@_attrs_define
class PageBranchInfoItemsItem:
    """
    Attributes:
        branch_id (str):
        created_at (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_branch_info_items_item = cls(
            branch_id=branch_id,
            created_at=created_at,
            head_lsn=head_lsn,
            fork_lsn=fork_lsn,
        ...
        page_branch_info_items_item.additional_properties = d
        return page_branch_info_items_item
